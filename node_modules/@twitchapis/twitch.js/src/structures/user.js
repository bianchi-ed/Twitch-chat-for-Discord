...
exports.UserStructure = exports.BasicUserStructure = void 0;
class BasicUserStructure {
    constructor(client, data) {
        ...
        this.self = (_b = (_a = data.self) !== null && _a !== void 0 ? _a : this.client.user.username === this.username) !== null && _b !== void 0 ? _b : false;
    }
}
exports.BasicUserStructure = BasicUserStructure;
class UserStructure extends BasicUserStructure {
    constructor(client, data) {
        super(client, data);
     ...
     */
    timeout(channel, seconds, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.client
                .getWebSocketManager()
                .sendMessage(this.channel ? (typeof this.channel === 'string' ? this.channel : this.channel.name) : channel.toString(), '/timeout ' + this.username + ' ' + seconds + ' ' + reason);
        });
    }
    /**
    ...
    ban(channel, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!channel || !(channel instanceof Array)) {
                ...
                return this.client
                    .getWebSocketManager()
                    .sendMessage(this.channel ? (typeof this.channel === 'string' ? this.channel : this.channel.name) : channel.toString(), '/ban ' + this.username + ' ' + reason);
            }
            else {
                if (!reason)
                    reason = '';
                channel.forEach((element) => {
                    this.client
                        .getWebSocketManager()
                        .sendMessage(element, '/ban ' + this.username + ' ' + reason);
                });
            }
        });
    }
    ...
    unban(channel) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!channel || !(channel instanceof Array)) {
                return this.client
                    .getWebSocketManager()
                    .sendMessage(this.channel ? (typeof this.channel === 'string' ? this.channel : this.channel.name) : typeof channel === 'string' ? channel : channel.join(', '), '/unban ' + this.username);
            }
            else {
                channel.forEach((element) => {
                    this.client
                        .getWebSocketManager()
                        .sendMessage(element, '/unban ' + this.username);
                });
            }
        });
    }
