 ...
 * @private
 */
function logOptions(defaultOptions, options) {
    return new Promise((resolve) => {
        var _a;
        const newOptions = (0, lodash_merge_1.default)(defaultOptions, options);
        if (newOptions.debug) {
        ...
        const logger = new logger_js_1.Logger(newOptions.loggerOptions);
        logger.debug('Debug Mode Enabled!');
        if (newOptions.autoLogEndEnabled) {
            logger_js_1.autoLogEnd.activate((_a = newOptions.autoLogEndUncaughtException) !== null && _a !== void 0 ? _a : false);
